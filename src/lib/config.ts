...
const envSchema = z.object({
  ...
  CLOSE_LEAD_UTM_SOURCE_FIELD_ID: optionalTrimmedOptionalEnv,
  CLOSE_LEAD_UTM_MEDIUM_FIELD_ID: optionalTrimmedOptionalEnv,
  CLOSE_LEAD_UTM_CAMPAIGN_FIELD_ID: optionalTrimmedOptionalEnv,
  CLOSE_LEAD_UTM_TERM_FIELD_ID: optionalTrimmedOptionalEnv,
  CLOSE_LEAD_UTM_CONTENT_FIELD_ID: optionalTrimmedOptionalEnv,
  ...
  CLOSE_SCORE_FIELD_ID: optionalTrimmedOptionalEnv,
  CLOSE_BAND_FIELD_ID: optionalTrimmedOptionalEnv,
  ...
  CLOSE_CONTACT_PREFERENCE_FIELD_ID: optionalTrimmedOptionalEnv,
...
const parsed = envSchema.safeParse({
  ...
  CLOSE_LEAD_UTM_SOURCE_FIELD_ID: process.env.CLOSE_LEAD_UTM_SOURCE_FIELD_ID,
  CLOSE_LEAD_UTM_MEDIUM_FIELD_ID: process.env.CLOSE_LEAD_UTM_MEDIUM_FIELD_ID,
  CLOSE_LEAD_UTM_CAMPAIGN_FIELD_ID:
    process.env.CLOSE_LEAD_UTM_CAMPAIGN_FIELD_ID,
  CLOSE_LEAD_UTM_TERM_FIELD_ID: process.env.CLOSE_LEAD_UTM_TERM_FIELD_ID,
  CLOSE_LEAD_UTM_CONTENT_FIELD_ID: process.env.CLOSE_LEAD_UTM_CONTENT_FIELD_ID,
  ...
  CLOSE_SCORE_FIELD_ID: process.env.CLOSE_SCORE_FIELD_ID,
  CLOSE_BAND_FIELD_ID: process.env.CLOSE_BAND_FIELD_ID,
  ...
  CLOSE_CONTACT_PREFERENCE_FIELD_ID:
    process.env.CLOSE_CONTACT_PREFERENCE_FIELD_ID,
