          ...
          <ol className="space-y-5">
            {accelerator.points.map((point, index) => (
              <li
                key={point}
                data-reveal
                className="group flex items-start gap-6 rounded-[12px] border-2 border-[#111111] bg-white p-6 shadow-[6px_6px_0_#55b8e8] transition hover:-translate-y-1 hover:shadow-[9px_9px_0_#2a8fcc] lg:p-8"
                style={
              ...
              >
                <span
                  aria-hidden
                  className="v2-display v2-outline text-[2.75rem] leading-none transition group-hover:[-webkit-text-stroke-color:#2a8fcc]"
                >
