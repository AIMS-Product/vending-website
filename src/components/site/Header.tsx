  ...
  return (
    <header className="sticky inset-x-0 top-0 z-30 border-b-2 border-[#111111] bg-[#f5fbff]/95 backdrop-blur-md">
      <div className="mx-auto flex max-w-[1500px] items-center justify-between gap-8 px-5 py-4 lg:px-10">
        ...
        <Link
          href={headerCta.href}
          className="bg-brand-700 hidden min-h-12 items-center rounded-[8px] border-2 border-[#111111] px-7 text-sm font-black text-white uppercase shadow-[5px_5px_0_#111111] transition hover:-translate-y-0.5 hover:shadow-[7px_7px_0_#111111] focus-visible:ring-2 focus-visible:ring-[#55b8e8] focus-visible:ring-offset-2 focus-visible:outline-none lg:inline-flex"
        >
          {headerCta.label}
        </Link>
      ...
      >
        <div className="mx-auto flex max-w-[1400px] flex-col gap-1">
          ...
          <Link
            href={headerCta.href}
            className="bg-brand-700 mt-3 inline-flex min-h-12 items-center justify-center rounded-[8px] border-2 border-[#111111] px-6 text-sm font-black text-white uppercase shadow-[4px_4px_0_#111111] focus-visible:ring-2 focus-visible:ring-[#066a99] focus-visible:ring-offset-2 focus-visible:outline-none"
            onClick={() => setMenuOpen(false)}
          >
            {headerCta.label}
          </Link>
