...
import { floatingRailButtonClass } from "@/components/admin/seo-page-editor/editor-styles";
...
export function SeoPageEditorTopRail({
  ...
  const blockToggleTitle = isNarrowEditor
    ? isBlockSidebarCollapsed
      ? blockSidebarExpandTitle
      : "Close blocks panel"
    : isBlockSidebarCollapsed
  ...
  const seoToggleTitle = isNarrowEditor
    ? isSeoSidebarCollapsed
      ? seoSidebarExpandTitle
      : "Close SEO panel"
    : isSeoSidebarCollapsed
