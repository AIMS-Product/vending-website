      ...
      actions={
        <>
          <Link
            ...
            className="inline-flex h-12 items-center justify-center gap-2 rounded-md border border-slate-200 bg-white px-5 text-sm font-semibold text-slate-950 shadow-sm transition hover:bg-slate-50 focus-visible:ring-2 focus-visible:ring-[#0b63f6]/35 focus-visible:outline-none"
          >
            <span aria-hidden="true">
              <PageIcon icon="layers" />
            </span>
            Content libraries
          </Link>
          <Link
            ...
            <table className="w-full min-w-[980px] border-collapse text-left text-sm">
              ...
              <tbody className="divide-y divide-slate-200">
                {visiblePages.map((page, index) => (
                  <PageRow key={page.id} page={page} isFirst={index === 0} />
                ))}
              </tbody>
            </table>
          </div>
