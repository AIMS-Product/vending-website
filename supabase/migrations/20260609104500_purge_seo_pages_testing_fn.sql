-- One-shot testing utility: remove all SEO builder pages and dependent rows.
-- Revisions are normally immutable; this function temporarily disables the delete
-- guard so local/test databases can be reset safely.
